...
const Learning = () => {
    return (
        ...
        <main className="flex flex-col h-full items-center ">
            ...
            <div className="flex-1 bg-white rounded-xl border-2 border-black m-2 p-5 w-3/4 ">
                <h1 className="text-2xl font-bold p-3 text-center">Learning</h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div className="flex items-start gap-4">
                        <img src={ValveCover} className="h-32 w-32 object-cover transition-transform duration-300 hover:scale-150 origin-center rounded-lg" />
                        <div>
                    ...
                    <div className="flex items-start gap-4">
                        <img src={Insulation} className="h-32 w-32 object-cover transition-transform duration-300 hover:scale-150 origin-center rounded-lg" />
                        <div>
                    ...
                    <div className="flex items-start gap-4">
                        <img src={Marathon} className="h-32 w-32 object-cover transition-transform duration-300 hover:scale-150 origin-center rounded-lg" />
                        <div>
                    ...
                    <div className="flex items-start gap-4">
                        <img src={Plaster} className="h-32 w-32 object-cover transition-transform duration-300 hover:scale-150 origin-center rounded-lg" />
                        <div>
                    ...
                    <div className="flex items-start gap-4">
                        <img src={BomDia} className="h-32 w-32 object-cover transition-transform duration-300 hover:scale-150 origin-center rounded-lg" />
                        <div>
